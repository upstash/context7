...
class SyncHttpClient:
    """Synchronous HTTP client with retry logic for Context7 API."""
        ...
        for attempt in range(self.retries + 1):
            try:
                ...
                if "application/json" in content_type:
                    ...
                    headers = _extract_txt_headers(response.headers)
...
class AsyncHttpClient:
    """Asynchronous HTTP client with retry logic for Context7 API."""
...
def _extract_txt_headers(headers: httpx.Headers) -> TxtResponseHeaders | None:
    """
