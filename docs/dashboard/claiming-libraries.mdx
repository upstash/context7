...
<Steps>
  <Step title="Navigate to the Admin Page">
    Go to your library's admin page at:

    ```
    https://context7.com/admin/{owner}/{repo}
    ```

    For example: `https://context7.com/admin/vercel/next.js`

    If you haven't claimed the library yet, you'll see a "Claim Library" button.

    ![Admin page with claim button](/images/dashboard/admin/claim-button.png)

  </Step>

  <Step title="Get Your Public Key">
    Click "Claim Library" to open the claiming modal. You'll see a generated `context7.json` configuration with your unique public key:

    ![Claim library modal](/images/dashboard/admin/claim-modal.png)
...
After claiming your library, the admin page shows a full configuration editor:

![Admin configuration page](/images/dashboard/admin/config-overview.png)
...
![Basic information section](/images/dashboard/admin/basic-info.png)
...
![Repository settings section](/images/dashboard/admin/repo-settings.png)
...
![LLM configuration section](/images/dashboard/admin/llm-config.png)
...
![Advanced settings section](/images/dashboard/admin/advanced-settings.png)
...
![Versions tab](/images/dashboard/admin/versions-tab.png)
...
![Metrics tab](/images/dashboard/admin/metrics-tab.png)
...
- Pagination for libraries with many unique queries
...
View the geographic distribution of requests to your library, showing:
...
After making changes, click "Save Configuration" at the bottom of the form. A success message confirms your changes were saved.

![Save button](/images/dashboard/admin/save-button.png)

<Note>
  Changes take effect immediately. However, you may need to trigger a library refresh for the parser
  to re-index with new settings.
</Note>

## Exporting Configuration

You can export your current admin configuration as a `context7.json` file by clicking "Copy context7.json" button. This is useful for:

- Backing up your configuration
- Migrating settings to another library
...
1. Wait for the next scheduled parse
2. Manually trigger a refresh from the library page
3. Clear any cached documentation on your end
