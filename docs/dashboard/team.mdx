...
![Create team dropdown](/images/dashboard/create-team-dropdown.png)

1. Click "Create a team" from the top left dropdown
2. Enter team name

<Note>
You must have Pro or Enterprise plan to create a team.
</Note>
...
<Note>
They will remain as a pending invitation until they sign in.
</Note>
