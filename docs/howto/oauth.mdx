...
OAuth authentication requires your MCP client to support the [MCP OAuth specification](https://modelcontextprotocol.io/specification/2025-03-26/basic/authorization). Check your client's documentation to see if OAuth is supported. If your client doesn't support OAuth, use [API key authentication](/howto/api-keys) instead.
