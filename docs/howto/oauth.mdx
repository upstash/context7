...
Use the canonical endpoint in your client configuration. It advertises OAuth when it challenges an unauthenticated request:

```json
{ "url": "https://mcp.context7.com/mcp" }
```

The older `/mcp/oauth` URL remains available as a compatibility alias.

## How It Works

1. Your MCP client connects to the MCP endpoint and receives an authentication challenge
