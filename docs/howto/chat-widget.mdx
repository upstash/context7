...
<Note>The chat widget is available to library owners who have [claimed their library](/dashboard/libraries).</Note>
...
<Steps>
  <Step title="Claim Your Library">
    You must be a verified owner of the library on Context7. If you haven't claimed it yet, follow the [Claim Your Library](/dashboard/libraries) guide.
  </Step>
