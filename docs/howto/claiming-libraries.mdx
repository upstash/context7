...
<Note>Library claiming is available for GitHub repositories, websites, and llms.txt sources.</Note>
...
<Steps>
  ...
  <Step title="Verify Ownership">
    ...
    <Note>
      For private GitHub repositories, ensure you have the Context7 GitHub App installed with access to the repository.
    </Note>
  </Step>
</Steps>
...
Available for GitHub repositories and websites.
