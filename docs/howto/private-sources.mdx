...
<Note>
  You must have a Pro or Enterprise plan to add private sources. Parsing is billed at $5 per 1M
  tokens processed. Public sources can be added from the [Add Library](https://context7.com/add-library)
  page.
</Note>
