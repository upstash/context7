...
The Context7 Codex plugin connects Codex to the hosted Context7 MCP server and bundles a documentation lookup skill. After adding the plugin, a browser window opens so you can log in via OAuth.
