...
<Frame>
  ![Entra SSO card with credentials and role values filled in](/images/enterprise/entra-sso/08-filled-credentials.png)
</Frame>
...
<Frame>
  ![Green success banner after a successful test](/images/enterprise/entra-sso/09-test-success.png)
</Frame>
