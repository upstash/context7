...
- **MCP**: restricted libraries are hidden from library search results, and a documentation request for a library the user cannot access returns an access denied message.
