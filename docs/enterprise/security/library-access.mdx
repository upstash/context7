...
Open **Teamspace Settings**, go to the **Policies** tab, and find the **Library access** section. You get a table of every indexed library, its current access, and who can reach it, with the workspace default at the top. Search by name, filter to restricted libraries only, and edit any library inline.

<Frame>
  ![The Library Access settings tab showing the default toggle and a table of libraries with their access and members](/images/enterprise/library-access/04-access-overview.png)
</Frame>
...
New libraries are open to everyone unless you change the workspace default. Use the **Restrict libraries by default** toggle at the top of the Library access section.
