...
<Note>
The Context7 Helm chart renders all of this from a few values: the single-replica StatefulSet by default, or a multi-replica Deployment with `scaling.enabled=true`. It ships with the enterprise distribution.
</Note>
