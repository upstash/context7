...
- The App must be subscribed to push events. Apps created after this feature shipped are subscribed automatically; if you set up the GitHub App earlier, add the push event (and the webhook URL above) in the App's settings on GitHub, or recreate it.
