...
<Update label="2026-09-16" description="v1.3.9">

### Added

- Added native AWS Bedrock support for Anthropic Claude inference, Amazon Titan embeddings, reranking, and source-code documentation.
