...
Prefer a plugin? The Context7 Codex plugin connects Codex to the hosted Context7 MCP server and bundles a skill that triggers documentation lookups when you ask about libraries:
