...
You can also install Context7 as an OpenCode plugin. It bundles the MCP server with a skill, a subagent, and a command:
...
The plugin is an alternative to `ctx7 setup` for people who want the subagent and the command as well. It adds four things:
