...
|--------|----------|-------------|
| [Search Documentation](/api-reference/search/search-documentation-in-one-request) | `GET /api/v2/search` | Find relevant documentation without resolving a library first |
