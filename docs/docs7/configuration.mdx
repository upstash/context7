...
## Validate docs.json in your editor

Point `$schema` at the Docs7 schema. Your editor then completes and checks the Mintlify fields and the Docs7-only fields on this page.
...
The Mintlify schema at `https://mintlify.com/docs.json` also works, but it marks the Docs7-only fields as unknown.
