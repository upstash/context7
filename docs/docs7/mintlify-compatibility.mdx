...
| **Icon library default** | Defaults to Hugeicons instead of Font Awesome. Set `"icons": { "library": "fontawesome" }` (or `lucide`, `tabler`) to keep your icon names resolving. Unknown icon names render as nothing and show up as build warnings. |
