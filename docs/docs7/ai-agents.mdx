...
A Docs7 site can be indexed into Context7 itself, so coding agents get your latest docs through the Context7 MCP, and you can embed the [chat widget](/howto/chat-widget) on the site. Both are toggles in the site's dashboard settings; production deployments refresh the index automatically.
