...
The upload can contain at most 100,000 files. Its total size must be at most 1 GiB before compression and 200 MiB after compression.
...
<Warning>
  ...
  lists it for removal. After the downgrade, delete `.docs7/project.json` from your documentation
  folder. Then run `docs7 deploy` to create a new site.
</Warning>
