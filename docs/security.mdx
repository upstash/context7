---
title: Security
description: Security and privacy practices for Context7
---
...
2. Only these generated topics are sent to the Context7 server
...
<Note>
The MCP client processes your queries locally and only transmits topic information needed to retrieve relevant documentation. Your full prompts, code, and context remain private.
</Note>
...
2. Email security details to: [GitHub Security](https://github.com/upstash/context7/security)
...
- **Library Documentation**: Retained while library is active and public
