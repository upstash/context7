...
<Accordion title="How does the Pro plan pricing work?" icon="credit-card">
  Pro plan costs $7 per seat per month. Each team member counts as a seat, and you're billed based
...
<Accordion title="Can I cancel my Pro subscription at any time?" icon="xmark">
  Yes, you can downgrade to the Free plan at any time. You will be charged a pro-rated amount for
  the days of your current billing period.
</Accordion>
...
<Accordion title="How do you ensure the code snippets are safe?" icon="check">
  We follow several processes to ensure safety: - Run an LLM-based model to detect injection
  attempts before storing code - Assign a trustScore to repository authors - Allow users to filter
  trusted libraries by organization and repository - Regular security audits and monitoring
</Accordion>
