...
| **Daily Quota**             | 200 req/day | 200 req/day + $5/1K extra | Custom     |
...
<AccordionGroup>
  <Accordion title="Is API usage unlimited?" icon="infinity">
    All users get 200 free requests per day. Pro users can purchase additional requests at $5 per
    1,000 requests beyond the free quota. For custom quotas and high-volume usage, please contact us
    at [context7@upstash.com](mailto:context7@upstash.com) to discuss Enterprise plan options.
  </Accordion>
</AccordionGroup>
