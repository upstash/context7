...
Restrict which public repositories are accessible to your teamspace. You can choose between two modes:

- **Filter by Quality** — set criteria like minimum stars, minimum trust score, and recency or block specific libraries or organizations from appearing in results
- **Select Manually** — pick specific libraries or organizations

<Frame>
![Public Repository Filters card showing quality filters and blocked libraries](/images/dashboard/public-repository-filters.png)
</Frame>
