...
You can limit retrieval scope by specifying which libraries or organizations are accessible under `Public Library Access` in the **Libraries** tab on your Context7 dashboard.
This lets you limit content to libraries you trust and prefer.

<Frame>
![Selecting libraries and organizations for retrieval](/images/dashboard/library-access-selector.png)
</Frame>
